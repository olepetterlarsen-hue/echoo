...
// DefaultValueEditor er delt komponent i src/components/app/default-value-editor.tsx
// slik at både denne (custom-mal-bygger) og /admin/maler/[kind] (samsvar +
// andre kanoniske) får token-palette med samme oppførsel.
